...
DWORD WINAPI NewGetTimeZoneInformation(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetTimeZoneInformation");
...
BOOL WINAPI NewGetComputerNameA(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetComputerNameA");
...
BOOL WINAPI NewGetComputerNameW(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetComputerNameW");
...
BOOL WINAPI NewGetDiskFreeSpaceA(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetDiskFreeSpaceA");
...
BOOL WINAPI NewGetDiskFreeSpaceW(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetDiskFreeSpaceW");
