...
HANDLE WINAPI NewFindResourceA( //FindResourceA -> winbase.h
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call FindResourceA");
...
HANDLE WINAPI NewFindResourceW( //FindResourceW -> libloaderapi.h
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call FindResourceW");
...
HANDLE WINAPI NewLoadResource(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call LoadResource");
...
DWORD WINAPI NewSizeofResource(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call SizeofResource");
