...
DWORD WINAPI NewGetTickCount(VOID) {
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetTickCount");
...
VOID WINAPI NewGetLocalTime(_Out_ LPSYSTEMTIME lpSystemTime) {
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetLocalTime");
...
VOID WINAPI NewGetSystemTimeAsFileTime(_Out_ LPFILETIME lpSystemTimeAsFileTime) {
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call GetSystemTimeAsFileTime");
...
VOID WINAPI NewSleep(
	...
	DebugLog("%d %ls", GetCurrentProcessId(), "has been call Sleep");
